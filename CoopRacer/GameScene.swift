...
final class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        // Run this heavy setup exactly once per scene lifetime
    ...
    override func didChangeSize(_ oldSize: CGSize) {
        ...
        // No full rebuild here – avoids stutters and long load times
        // In future you can adjust HUD / labels here if needed.
    }
    ...
    // (currently unused in scrolling forest, but kept for future use)
    ...
    private func makeTreeCanopy(baseRadius: CGFloat = 18) -> SKNode {
        ...
        for _ in 0..<blobCount {
            ...
            circle.zPosition = CGFloat.random(in: 0...1.0)
